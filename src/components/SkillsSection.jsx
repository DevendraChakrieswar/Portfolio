...
const skills = [
    ...
    {name: "Java Script", level: 90, category: "frontend"},
    ...
    {name: "Intellji Idea", level: 80, category: "tools"},
    {name: "Postman", level: 90, category: "tools"},

    // programming
    {name: "Java", level: 80, category: "programming"},
    {name: "C/Cpp", level: 60, category: "programming"},
...
export const SkillsSection = () => {
    ...
    return(
        <section id="skills" className="py-24 px-4 relative bg-secondary/30 max-w-5xl mx-auto">
